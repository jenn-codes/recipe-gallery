      ...
      <Card sx={{ width: 600 }}>
        <Grid container>
          <Grid item xs={1} direction="column" container justifySelf="center">
            <Button align="left" size="small" onClick={() => likePost(id)}>
              <ArrowCircleUpOutlinedIcon />
            </Button>
            {likes}
            <Button align="left" size="small" onClick={() => dislikePost(id)}>
          ...
          <Grid item xs={11}>
            <CardContent>
              ...
              <CardActions>
                ...
                <Button size="small" onClick={() => sharePost(id)}>
                  <ShortcutIcon /> share
                </Button>
                <Button size="small" onClick={() => savePost(id)}>
